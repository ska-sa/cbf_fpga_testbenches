...
f.get_system_information('test_hmc_vacc1_2017-3-29_1700.fpg')
#f.registers.vacc_rst=1
#f.registers.hmc_vacc_ctrl_rb_disable=0

#f.registers.acc_len.write(reg=10)


#f.registers.vacc_tvg0_n_per_group.write(reg=14)
...
f.snapshots.hmc_vacc_hmc_in_rd_snap_ss.arm(circular_capture=True)
f.snapshots.hmc_vacc_hmc_in_wr_snap_ss.arm(circular_capture=True)
f.snapshots.hmc_vacc_hmc_out_snap_ss.arm(circular_capture=True)
f.snapshots.hmc_vacc_qdr_out_snap_ss.arm(circular_capture=True)
